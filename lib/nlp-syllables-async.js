...
/***/ function(module, exports, __webpack_require__) {
	...
	function getSyllablesForWord(word) {
	  ...
	  return (0, _fallbackOnTimeout2.default)(lookupSyllables, guessSyllables, 5000).catch(function (err) {
...
/***/ function(module, exports) {
	...
	function fallbackOnTimeout(func, fallback) {
	  var waitTime = arguments.length <= 2 || arguments[2] === undefined ? 5000 : arguments[2];
