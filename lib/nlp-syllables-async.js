...
})(this, function(__WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_8__, __WEBPACK_EXTERNAL_MODULE_12__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dictionary = new _syllableDictionary2.default(null, defaultTimeout);
	...
	var settings = {
	  ...
	  setCacheEntries: function setCacheEntries(entries) {
	    dictionary = new _syllableDictionary2.default(entries, this.timeout);
	  },
	  ...
	  setTimeout: function setTimeout(timeout) {
	    ...
	    var serialized = this.serializeCache();
	    dictionary = new _syllableDictionary2.default(serialized, this.timeout);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cacheFunction = __webpack_require__(10);
	...
	var SyllableDictionary = function () {
	  function SyllableDictionary(cacheEntries, timeout) {
	  ...
	  _createClass(SyllableDictionary, [{
	    ...
	    value: function getSyllables(text) {
	      switch (getType(text)) {
	        ...
	        case 'word':
	          return this.getCachedSyllablesForWord(text, this.timeout);
	      }
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fallbackOnTimeout = __webpack_require__(9);
	
	var _fallbackOnTimeout2 = _interopRequireDefault(_fallbackOnTimeout);
	...
	function lookup(word) {
	  ...
	  return (0, _scrape2.default)(url, selector).then(function (results) {
	    var match = findMatch(word, results);
	    var syllableData = match[0].attribs['data-syllable'].split(syllableDelimiter);
	    var format = function format(syllable) {
	      return syllable.replace(/[^a-z]/gi, '').trim();
	    };
	...
	function getSyllablesForWord(word, timeout) {
	  var lookupSyllables = function lookupSyllables() {
	    return lookup(word);
	  };
	  var guessSyllables = function guessSyllables() {
	    return _nlp_compromise2.default.term(word).syllables();
	  };
	  return (0, _fallbackOnTimeout2.default)(lookupSyllables, guessSyllables, timeout).catch(function (err) {
...
/***/ function(module, exports) {
	...
	exports.default = fallbackOnTimeout;
	...
	function fallbackOnTimeout(func, fallback, waitTime) {
	  return new Promise(function (resolve, reject) {
	    try {
	      (function () {
	        var useFallback = function useFallback() {
	          var result = fallback();
	          resolve(result);
	        };
	        var timeoutId = setTimeout(useFallback, waitTime);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _persistentCache = __webpack_require__(11);
	...
	function cacheFunction(func, cache) {
	  if (Array.isArray(cache)) {
	    cache = new _persistentCache2.default(cache);
	  } else if (!cache) {
	  ...
	  var cachedFunction = function cachedFunction() {
	    ...
	    var prom;
	    if (cached == null) {
	      prom = func.apply(undefined, arguments);
	    } else {
